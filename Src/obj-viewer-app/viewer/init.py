...
def create_dash_app():
    ...
    # --- Dataset options ---
    DATASET_OPTIONS = ['Data', 'Data_sampled', 'Data_resampled', 'Data_sampled_resampled', 'Data_sampled_resampled_normalized', 'Data_sampled_resampled_simple', 'NormalizedShapes']
